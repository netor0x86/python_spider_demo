...
// e1 = 'appId=5053&cityCode=110100&t=1713322519335750F82C2-D8F6-49F6-878C-1E7EBEBC8DA2'
// n = undefined
// // console.log(window.loader)
// console.log(window.loader("aCH8")(e1, n))
// // console.log(window.loader("aCH8").e)
// // console.log(window.loader("aCH8").e(e1, n))

function getSign(data) {
    return window.loader('aCH8')(data, undefined)
}
