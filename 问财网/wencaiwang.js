var TOKEN_SERVER_TIME = 1714360187.237;
window = global;
document = {}
    ...
    !function() {
        ...
        !function(n) {
            var t = u[165]
              ...
              , I = s[2]
              , y = s[67]
              , _ = 'wheel' // t + X in s[66].createElement(s[171]) ? o + G + i : s[172]in c[66] ? u[173] : v + K + f + Q;
        ...
        !function(n) {
            ...
            function P() {
                ...
                S[b] = 3748, //tt.getBrowserFeature(),
                S[g] = 7, // tt.getPlatform(),
